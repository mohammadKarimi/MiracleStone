...
namespace MiracleStone.Web.Controllers
{
    public partial class ProductController
    {
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string ListOfProduct = "ListOfProduct";
        ...
        public class ActionNameConstants
        {
            ...
            public const string ListOfProduct = "ListOfProduct";
        ...
        {
            public readonly string categoriesID = "categoriesID";
        }
        ...
        {
            public readonly string TblProductID = "TblProductID";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Add = "~/Views/Product/Add.cshtml";
            public readonly string Edit = "~/Views/Product/Edit.cshtml";
            public readonly string GetAllImage = "~/Views/Product/GetAllImage.cshtml";
            public readonly string List = "~/Views/Product/List.cshtml";
            public readonly string ListOfProduct = "~/Views/Product/ListOfProduct.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProductController : MiracleStone.Web.Controllers.ProductController
    {
        public T4MVC_ProductController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int categoriesID);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(int categoriesID)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.List);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "categoriesID", categoriesID);
            ListOverride(callInfo, categoriesID);
            return callInfo;
        }
        ...
        [NonAction]
        partial void ListOfProductOverride(T4MVC_System_Web_Mvc_ViewResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ViewResult ListOfProduct()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ViewResult(Area, Name, ActionNames.ListOfProduct);
            ListOfProductOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MiracleStone.Domain.Entity.TblProduct model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Add(MiracleStone.Domain.Entity.TblProduct model)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MiracleStone.Domain.Entity.TblProduct model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(MiracleStone.Domain.Entity.TblProduct model)
        {
        ...
        [NonAction]
        partial void RemoveOverride(T4MVC_System_Web_Mvc_RedirectToRouteResult callInfo, int TblProductID);

        [NonAction]
        public override System.Web.Mvc.RedirectToRouteResult Remove(int TblProductID)
        {
            var callInfo = new T4MVC_System_Web_Mvc_RedirectToRouteResult(Area, Name, ActionNames.Remove);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "TblProductID", TblProductID);
            RemoveOverride(callInfo, TblProductID);
            return callInfo;
        }
